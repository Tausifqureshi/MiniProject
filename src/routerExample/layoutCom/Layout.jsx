...
export default function Layout() {
  ...
  const [mobileSidebarOpen, setMobileSidebarOpen] = useState(false); // 📱 sidebar
  const [mobileDropdownOpen, setMobileDropdownOpen] = useState(false);
    ...
    <div className="flex flex-col min-h-screen font-sans">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <div
              ...
              ref={dropdownRef}
              onMouseEnter={() => {
                if (windowWidth >= 768) setIsHovering(true);
              }}
              onMouseLeave={() => {
                if (windowWidth >= 768) setIsHovering(false);
              }}
            >
              <button
                className="hover:underline px-2 py-1"
      ...
      {mobileSidebarOpen && (
        <>
          ...
          {/* Sidebar */}
          <div
            //  className="fixed top-0 left-0 w-64 h-full bg-blue-600 text-white z-50 p-4 flex flex-col"
            className={`fixed top-0 left-0 w-64 h-full bg-blue-600 text-white z-50 p-4 flex flex-col
