...
function SingleSeeMore() {
  ...
  const toggleExpand = (index) => {
    setExpandedIndex((expandedIndex) =>expandedIndex !== index ? index : null);//agar wo clicked card ke index ke barabar nahi hai to naya open kar,warna null kar (band ka
   };

  return (
    <div className="min-h-screen bg-gray-100 py-10 px-5">
      <h2 className="text-2xl font-bold text-center mb-8">
        ⚡ Single See More / See Less (Accordion Style)
      </h2>
